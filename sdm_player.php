...
<body>
  ...
  <div id="test">
  <!-- the audio id should be set to the song that is to be played once current song is finished playing || default should be == the machine name of the first song in the db -->
  </div>
  <?php
  if ($sdm_player_errors) {
    print '<!-- SDM PLAYER ERRORS -->';
    print '<div class="sdm-player-errors-wrapper">';
    ...
    print '</div> <!-- close "sdm-player-errors-wrapper" -->';
  }
  ?>
</body>
</html>