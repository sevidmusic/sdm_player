...
if (!$sdm_new_song_info_con) {
    ...
    $sdm_new_song_info_sql_sname = "SELECT sdm_song_name AS sname  FROM sdm_song_info WHERE sdm_song_machine_name = '" . $sdm_get_song_name . "'";
    ...
    $sdm_new_song_info_sql_salbum = "SELECT sdm_song_album AS salbum  FROM sdm_song_info WHERE sdm_song_machine_name = '" . $sdm_get_song_name . "'";
...
if ($sdm_get_song_name) {
    $sdm_new_controls_con = mysql_connect('localhost:8888', 'root', 'root');
    if (!$sdm_new_controls_con) {
        ...
        $sdm_new_controls_sql = "SELECT sdm_song_machine_name AS sdm_mname, sdm_song_ogg_url AS ogg_url, sdm_song_mp3_url AS mp3_url FROM sdm_song_file_info WHERE sdm_song_machine_name = '" . $sdm_get_song_name . "'";
        ...
        $sdm_new_controls_html[] = "<audio id=\"" . $sdm_new_controls_song_urls['sdm_mname'] . "\" controls=\"controls\" autoplay=\"autoplay\" onended=\"sdm_player_onEnd_change_song_ajax(this.id, 'sdm-player-main-wrapper')\">";
...
if ($sdm_player_features == 1) {
    ...
    if (!$sdm_new_lyric_con) {
        ...
        $sdm_new_lyric_sql = "SELECT sdm_song_lyrics AS sdm_lyrics FROM sdm_song_info WHERE sdm_song_machine_name = '" . $sdm_get_song_name . "'";
